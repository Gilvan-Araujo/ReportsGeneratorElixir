defmodule ReportsGeneratorTest do
  ...
  describe "build_from_many/1" do
    ...
    test "when a file list is not provided, returns an error" do
      ...
      expected_response = {:error, "Please provide a file list"}
  ...
  describe "fetch_higher_cost/2" do
    test "when the option is 'users', returns the user that spent the most" do
      filename = "report_test.csv"
    ...
    test "when the option is 'users', returns the most eaten food" do
      filename = "report_test.csv"
    ...
    test "when an invalid option is provided, it gives an error" do
      filename = "report_test.csv"

      response =
        filename
        |> ReportsGenerator.build()
        |> ReportsGenerator.fetch_higher_cost("tolkien")
